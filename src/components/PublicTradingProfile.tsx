      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          ...
          >
            <div className="flex items-center justify-between">
              <div>
                <h3 className="text-xl font-bold text-gray-900 mb-2">Cards for Trade</h3>
                <p className="text-gray-600">Browse {profile.username}'s available cards</p>
          ...
          >
            <div className="flex items-center justify-between">
              <div>
                <h3 className="text-xl font-bold text-gray-900 mb-2">Want List</h3>
                <p className="text-gray-600">See what {profile.username} is looking for</p>
        ...
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <p className="text-gray-600 mb-4">
            Contact {profile.username} through their social media links above to discuss potential trades.
          </p>
